...
test('Probar categoria camperas', () => {
    const resultado = filtrarProductos(productos, 'camperas');
    expect(resultado).toEqual(fitroCamperas);
});
test('Probar categoria remeras', () => {
    const resultado = filtrarProductos(productos, 'remeras');
    expect(resultado).toEqual(filtroRemeras);
});
test('Probar categoria pantalones', () => {
    const resultado = filtrarProductos(productos, 'pantalones');
    expect(resultado).toEqual(filtroPantalones);
});
test('Debe devolver un array vacío si le pasamos un array vacio', () => {
